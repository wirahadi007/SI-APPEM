                ...
                <form method="post" id="tes"  action="add-proses.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="nup" type="text" class="form-control" name="nup">
                            </div>                                                        
                        </div>
        ...
        <div class="col-sm-6 col-xs-12">
            <div class="box box-info">
                ...
                <table class="table table-responsive">
                        ...
                        <?php 
                            $sekarang  = date("Y-m-d");
                            $queryTampil = mysqli_query($koneksi, "SELECT sementara.unit, sementara.deskripsi, sementara.id_sementara, stokbarang.nama_brg,stokbarang.kode_brg, stokbarang.nup, jumlah FROM sementara INNER JOIN stokbarang ON sementara.nup = stokbarang.nup WHERE tgl_permintaan = '$sekarang' AND sementara.unit='$_SESSION[username]' && bagian = 5 "  );
                            $no = 1;
