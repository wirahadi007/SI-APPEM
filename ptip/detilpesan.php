<?php  
    ...
    if (isset($_GET['tgl'])) {
        $tgl = $_GET['tgl'];
        $query = mysqli_query($koneksi, "SELECT  permintaan.id_permintaan, permintaan.nup, nama_brg, jumlah, permintaan.kode_brg, status FROM permintaan INNER JOIN 
        stokbarang ON permintaan.nup = stokbarang.nup  WHERE tgl_permintaan='$tgl' AND unit='$_SESSION[username]' ");
