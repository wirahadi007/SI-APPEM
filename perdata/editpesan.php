                ...
                <form method="post"  action="edit_proses.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group ">
                            <label for="nama_brg" class="col-sm-offset-1 col-sm-3 control-label">Bagian</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <?php  
                                    ...
                                    $queryBarang = mysqli_query($koneksi, "select * from stokbarang_perdata");
                        ...
                        <div class="form-group">
                            <label for="keterangan" class="col-sm-offset-1 col-sm-3 control-label">Deskripsi</label>
                            <div class="col-sm-4">
