            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <table class="table table-responsive">
                        ...
                        <?php 
                            $sekarang  = date("Y-m-d");
                            $queryTampil = mysqli_query($koneksi, "SELECT sementara.unit, sementara.deskripsi, sementara.id_sementara, stokbarang.nama_brg,stokbarang.kode_brg, stokbarang.nup, jumlah FROM sementara INNER JOIN stokbarang ON sementara.nup = stokbarang.nup WHERE tgl_permintaan = '$sekarang' AND sementara.unit='$_SESSION[username]' && bagian = 1 "  );
                            $no = 1;
