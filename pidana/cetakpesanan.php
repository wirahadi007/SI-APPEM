   ...
   <table class="tabel2">
    ...
    <tbody>
      <?php
       ...
       $query = mysqli_query($koneksi, "SELECT permintaan.deskripsi, permintaan.kode_brg, unit, nama_brg, nup, jumlah, tgl_permintaan FROM permintaan INNER JOIN stokbarang_pidana ON permintaan.kode_brg = stokbarang_pidana.kode_brg  WHERE unit='$unit' AND  status=1 AND tgl_permintaan='$tgl' "); 
      $i   = 1;
