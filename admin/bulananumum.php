<?php  
	...
	if(isset($_GET['id_jenis'])){
        ...
        $query = mysqli_query($koneksi, "SELECT sementara.unit, sementara.deskripsi, sementara.id_sementara, stokbarang.nama_brg,stokbarang.kode_brg, stokbarang.nup, jumlah FROM sementara INNER JOIN stokbarang ON sementara.kode_brg  = stokbarang.kode_brg WHERE tgl_permintaan = '$sekarang' AND sementara.unit='$_SESSION[username]' ");    
    } else {
        $query = mysqli_query($koneksi, "SELECT * FROM laporan_sementara");        
    }
	...
	<div class="row">
		<div class="col-sm-12">
			 <div class="box box-primary">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <a href="index.php?p=tambahlaporan" class=" btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Stok</a><br>						
                    </div>
