                ...
                <form method="post"  action="add-proses.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select id="bagian" required="isikan dulu" class="form-control" name="id_bagian">
                                <option value="">--Pilih Jenis Barang--</option>
                                <?php  
                                    
                                    $queryBagian = mysqli_query($koneksi, "select * from bagian");
                                    if (mysqli_num_rows($queryBagian)) {
                        ...
                        <div class="form-group">
                            <label for="jumlah" class="col-sm-offset-1 col-sm-3 control-label">Anggaran</label>
                            <div class="col-sm-4">
