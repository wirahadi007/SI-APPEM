...
<!-- Setting Margin header/ kop -->
  ...
  <table>
    <tr>
      ...
      <br><br>Jl. Mayor Sugianyar No.1 Jembrana Bali <br> Telp : 0365 | Fax : 0365</td>
  ...
  <table class="tabel2">
    <thead>
      <tr>
        ...
        <td style="text-align: center; "><b>Anggaran Dipakai</b></td>
      </tr>
    </thead>
    <tbody>
      <?php
       ...
       $query = mysqli_query($koneksi, "SELECT pengeluaran.kode_brg, unit, nama_brg, jumlah, nup, tgl_keluar FROM pengeluaran INNER JOIN stokbarang ON pengeluaran.kode_brg = stokbarang.kode_brg  "); 
      $i   = 1;
      ...
      <tr>
		...
		<td style="text-align: center; width=70px;"><?php echo $data['nup']; ?></td> 
  ...
  <div class="kiri">
      <p>Mengetahui :<br>Pengadaan Barang</p>
      <br>
      <br>
      <br>
      <p><b><u>admin</u><br>NIK : 00000</b></p>
  </div>

  <div class="kanan">
      <p>Mengetahui :<br>Panitia Pembuat Keputusan </p>
      <br>
      <br>
      <br>
      <p><b><u>Roozelfelt</u><br>NIK : 007</b></p>
  </div>
