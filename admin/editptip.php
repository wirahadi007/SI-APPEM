<?php  
	...
	if (isset($_GET['id'])) {
		$id = $_GET['id'];
		$query = mysqli_query($koneksi, "SELECT * FROM stokbarang_ptip WHERE kode_brg = '$id' ");
        ...
        <div class="col-sm-8 col-sm-offset-2 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Update Data Barang PTIP</h3>
                </div>
                <form method="post"  action="edit_prosesptip.php" class="form-horizontal">
                    <div class="box-body">
