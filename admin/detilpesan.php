<?php  
    ...
    if (isset($_GET['tgl']) && isset($_GET['unit'])) {
        $tgl = $_GET['tgl'];
        $unit = $_GET['unit'];
        $query = mysqli_query($koneksi, "SELECT  permintaan.id_permintaan, permintaan.kode_brg, nama_brg, jumlah, permintaan.nup, status FROM permintaan INNER JOIN 
        stokbarang ON permintaan.nup = stokbarang.nup  WHERE tgl_permintaan='$tgl' AND unit='$unit' ");
        ...
        <div class="col-sm-12">
             <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Data Permintaan Bagian <?php echo $unit; ?></h3>
                </div>                
                <div class="box-body">                   
