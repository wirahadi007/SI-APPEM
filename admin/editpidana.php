<?php  
	...
	if (isset($_GET['id'])) {
		$id = $_GET['id'];
		$query = mysqli_query($koneksi, "SELECT * FROM stokbarang_pidana WHERE kode_brg = '$id' ");
        ...
        <div class="col-sm-8 col-sm-offset-2 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Update Data Barang Pidana</h3>
                </div>
                <form method="post"  action="edit_prosespidana.php" class="form-horizontal">
                    <div class="box-body">
