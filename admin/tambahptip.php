<?php  
    ...
    $query = mysqli_query($koneksi, "SELECT MAX(kode_brg) from stokbarang_ptip");
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Tambah Data Barang PTIP</h3>
                </div>
                <form method="post"  action="add-prosesptip.php" class="form-horizontal">
                    <div class="box-body">
