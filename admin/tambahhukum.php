<?php  
    ...
    $query = mysqli_query($koneksi, "SELECT MAX(kode_brg) from stokbarang_hukum");
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Tambah Data Barang Hukum</h3>
                </div>
                <form method="post"  action="add-proseshukum.php" class="form-horizontal">
                    <div class="box-body">
