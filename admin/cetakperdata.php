...
<!-- Setting Margin header/ kop -->
  ...
  <hr>
  <p align="center" style="font-weight: bold; font-size: 18px;"><u>LAPORAN DATA BARANG</u></p>
  <table class="tabel2">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      $sql = mysqli_query($koneksi, "SELECT * FROM stokbarang_perdata WHERE id_jenis = '$id' ");  
      $i   = 1;
