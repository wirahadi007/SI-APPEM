    ...
    <div class="row">
        <div class="col-sm-6 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post" id="tes"  action="addservice.php" class="form-horizontal">
                    <div class="box-body">
                         <div class="form-group">
                            <label for="unit" class=" col-sm-3 control-label">Bagian</label>
                            <div class="col-sm-5">
                                <input id="unit" type="text" required="isikan dulu" class="form-control" name="unit" required>                                
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input id="nup" type="number" required="isikan dulu" class="form-control" name="nup" required>                                
                            </div>
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <table class="table table-responsive">
                        ...
                        <?php 
                            //$sekarang  = date("Y-m-d");
                            $queryTampil = mysqli_query($koneksi, "SELECT laporanservice.deskripsi,laporanservice.id_laporan, jenis_barang.jenis_brg, hasilservice.status, laporanservice.nama_brg, laporanservice.nup, hasilservice.status, laporanservice.biaya, laporanservice.tgl_laporan FROM laporanservice INNER JOIN hasilservice ON laporanservice.id_service  = hasilservice.id_service  INNER JOIN jenis_barang on laporanservice.id_jenis = jenis_barang.jenis_brg"  );
                            $no = 1;
