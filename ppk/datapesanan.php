<?php  
    ...
    $query = mysqli_query($koneksi, "SELECT distinct(unit), tgl_permintaan FROM permintaan WHERE status!=1 ORDER BY tgl_permintaan DESC");    
?>
<!-- Main content -->
        ...
        <div class="col-sm-12">
             <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Data Permintaan Perbaikan Barang</h3>
                </div>                
