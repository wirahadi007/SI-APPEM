  ...
  <table class="tabel2">
    ...
    <tbody>
      <?php
       ...
       $query = mysqli_query($koneksi, "SELECT pengeluaran.kode_brg, unit, stokbarang.nup, nama_brg, jumlah, tgl_keluar FROM pengeluaran INNER JOIN stokbarang ON pengeluaran.kode_brg = stokbarang.kode_brg  "); 
      $i   = 1;
    ...
    <tbody>
      <?php
       ...
       include "../fungsi/koneksi.php";
       $query2 = mysqli_query($koneksi, "SELECT pengeluaran.kode_brg, unit, stokbarang_pidana.nup, nama_brg, jumlah, tgl_keluar FROM pengeluaran INNER JOIN stokbarang_pidana ON pengeluaran.kode_brg = stokbarang_pidana.kode_brg  "); 
      $i   = 1;
      ...
      <tr>
        <td style="text-align: center; width=15px;"><?php echo $i; ?></td>
		<td style="text-align: center; width=70px;"><?php echo tanggal_indo($data2['tgl_keluar']); ?></td>
        ...
        <td style="text-align: center; width=50px;"><?php echo $data2['jumlah']; ?></td>                   
      </tr>
    <?php
    $i++;
    }
    ...
    <tbody>
      <?php
       ...
       include "../fungsi/koneksi.php";
       $query3 = mysqli_query($koneksi, "SELECT pengeluaran.kode_brg, unit, stokbarang_perdata.nup, nama_brg, jumlah, tgl_keluar FROM pengeluaran INNER JOIN stokbarang_perdata ON pengeluaran.kode_brg = stokbarang_perdata.kode_brg  "); 
      $i   = 1;
      ...
      <tr>
        ...
        <td style="text-align: center; width=50px;"><?php echo $data3['jumlah']; ?></td>                   
      </tr>
    <?php
    $i++;
    }
    ...
    <tbody>
      <?php
       ...
       include "../fungsi/koneksi.php";
       $query4 = mysqli_query($koneksi, "SELECT pengeluaran.kode_brg, unit, stokbarang_hukum.nup, nama_brg, jumlah, tgl_keluar FROM pengeluaran INNER JOIN stokbarang_hukum ON pengeluaran.kode_brg = stokbarang_hukum.kode_brg  "); 
      $i   = 1;
      ...
      <tr>
        ...
        <td style="text-align: center; width=50px;"><?php echo $data4['jumlah']; ?></td>                   
      </tr>
    <?php
    $i++;
    }
    ...
    <tbody>
      <?php
       ...
       include "../fungsi/koneksi.php";
       $query5 = mysqli_query($koneksi, "SELECT pengeluaran.kode_brg, unit, stokbarang_ptip.nup, nama_brg, jumlah, tgl_keluar FROM pengeluaran INNER JOIN stokbarang_ptip ON pengeluaran.kode_brg = stokbarang_ptip.kode_brg  "); 
      $i   = 1;
      ...
      <tr>
        ...
        <td style="text-align: center; width=50px;"><?php echo $data5['jumlah']; ?></td>                   
      </tr>
    <?php
    $i++;
    }
