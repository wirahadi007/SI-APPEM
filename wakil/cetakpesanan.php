   ...
   <table class="tabel2">
    ...
    <tbody>
      <?php
       ...
       $query = mysqli_query($koneksi, "SELECT permintaan.deskripsi, permintaan.kode_brg, unit, nama_brg, nup, jumlah, tgl_permintaan FROM permintaan INNER JOIN stokbarang ON permintaan.kode_brg = stokbarang.kode_brg  WHERE unit='$unit' AND  status=1 AND tgl_permintaan='$tgl' "); 
      $i   = 1;
